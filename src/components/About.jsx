...
const About = () => {
  return (
    ...
    <div className="container mb-6 mt-0 ">
        ...
        <div className="info mt-0 pt-0">
            <p className="pr-12 text-lg text-slate-400">My name is Prince Nmezi, I am a React/Node engineer 👨🏽‍💻 with deep passion for the tech space, 
            ...
            <p className="pr-12 text-lg text-slate-400">
